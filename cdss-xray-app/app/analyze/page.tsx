  ...
  return (
    <ProtectedRoute>
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        {/* Main content area */}
        <div className="bg-gray dark:bg-black-800 rounded-xl shadow-lg p-6 mb-8">
                  ...
                  {vitals ? (
                    <div className="space-y-3">
                      <div className="grid grid-cols-2 gap-2">
                        <div className="bg-white-50 dark:bg-black-700/50 p-2 rounded">
                          <span className="text-black-500 dark:text-black-400 text-sm">Temperature</span>
                          <p className="font-medium">{vitals.temperature}°C</p>
                        </div>
                        <div className="bg-white-50 dark:bg-gray-700/50 p-2 rounded">
                          <span className="text-black-500 dark:text-gray-400 text-sm">Heart Rate</span>
                          <p className="font-medium">{vitals.heartRate} bpm</p>
                        </div>
                      </div>
                      
                      <div className="bg-white-50 dark:bg-gray-700/50 p-2 rounded">
                        <span className="text-black-500 dark:text-gray-400 text-sm">Blood Pressure</span>
                        <p className="font-medium">{vitals.systolicBP}/{vitals.diastolicBP} mmHg</p>
                      </div>
                      
                      <div className="bg-white-50 dark:bg-gray-700/50 p-2 rounded">
                        <span className="text--500 dark:text-gray-400 text-sm">Demographics</span>
                      ...
                      <div className="bg-white-50 dark:bg-gray-700/50 p-2 rounded">
                        <span className="text-black-500 dark:text-gray-400 text-sm">Symptoms</span>
                        <p>
                          {[
